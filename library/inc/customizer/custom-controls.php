 ...
 */
class library_Dropdown_Taxonomies_Control extends WP_Customize_Control {
...
class library_Customize_Horizontal_Line extends WP_Customize_Control {
	public $type = 'hr';
 ...
 * @see WP_Customize_Control
 */
class library_Dropdown_Category_Control extends WP_Customize_Control {
    ...
    <label>
      ...
      <?php endif; ?>
       <select <?php $this->link(); ?> multiple>
			<?php
			printf( '<option value="%s" %s>%s</option>', '', selected( $this->value(), '', false ), esc_html__( '--None--', 'library' ) );
			?>
			<?php if ( ! empty( $taxonomies ) ) :  ?>
            <?php foreach ( $taxonomies as $key => $tax ) :  ?>
				<?php
...
class library_Note_Control extends WP_Customize_Control {
 ...
 * @see WP_Customize_Control
 */
class library_Dropdown_Taxonomy extends WP_Customize_Control {
	/**
	 * Control type.
	 *
	 * @access public
