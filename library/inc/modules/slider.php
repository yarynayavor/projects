...
if ( ! function_exists( 'library_add_slider_section' ) ) :
  /**
   * Add slider section
   *
   *@since library 0.3
   */
  function library_add_slider_section() {

    // Check if slider is enabled on frontpage
    $slider_enable = apply_filters( 'library_section_status', true, 'slider_enable' );
    ...
    $section_details = apply_filters( 'library_filter_slider_section_details', $section_details );
    ...
    library_render_slider_section( $section_details );
  }
endif;
add_action( 'library_primary_content', 'library_add_slider_section', 10 );


if ( ! function_exists( 'library_get_slider_section_details' ) ) :
  /**
   ...
   */
  function library_get_slider_section_details( $input ) {
...
add_filter( 'library_filter_slider_section_details', 'library_get_slider_section_details' );


if ( ! function_exists( 'library_render_slider_section' ) ) :
  /**
   ...
   *
   */
   function library_render_slider_section( $content_details = array() ) {
        $options          = library_get_theme_options();
